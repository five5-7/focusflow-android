...
- The current development candidate is `8.3.0-rc.16` / versionCode 550: history multi-selection uses a unified material toolbar and motion-aware transitions. It retains rc.15's adaptive background and animation choices, which passed OPPO verification. Card-material layout and long appearance page remain separate planned work. It requires stable-signed CI and OPPO verification and is not merged or released; rc.15 is superseded.
