...
- The current development candidate is `8.2.2-rc.2` / versionCode 536: per-transport commute reserves, glass-card text contrast, and dismissible settings permission reminders. It is not merged or released.
