...
- The current development candidate is `8.2.2-rc.3` / versionCode 537: per-transport commute reserves, glass-card text contrast, and a Today permission entry with a settings fallback. It is not merged or released.
