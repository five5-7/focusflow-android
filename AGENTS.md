...
- FocusFlow uses 0.1 product-version increments, with patch versions for release fixes. The current release candidate is `7.2.0` / versionCode 480. Device acceptance is required before labeling it stable.
