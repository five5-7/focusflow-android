...
- FocusFlow uses 0.1 product-version increments. The current release candidate is `7.1.0` / versionCode 475. Device acceptance is required before labeling it stable.
