...
- The current development candidate is `8.2.1-rc.4` / versionCode 529. It extends the optional appearance system with distinct acrylic and frosted-glass profiles; rich appearance remains disabled by default.
