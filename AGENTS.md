...
- The current official release is `8.1.0` / versionCode 520, promoted from the accepted `8.1.0-rc.6` candidate. The previous official release is `8.0.0` / versionCode 513 (`v8.0.0`).
