...
- The current development candidate is `8.3.0-rc.21` / versionCode 555: rc.20 passed device acceptance. Today's inbox has direct capture, a count, and two compact recent previews; writes retain the transactional task-and-event path. Room product activation remains off. It requires stable-signed CI and OPPO interaction verification and is not merged or released; rc.20 is superseded.
