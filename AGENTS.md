...
- The current development candidate is `7.6.0-rc.3` / versionCode 493. The current official release remains `7.1.3`; `7.4.0` is the verified but not yet published predecessor candidate.
