...
- The current development candidate is `8.2.2-rc.4` / versionCode 538: per-transport commute reserves, glass-card text contrast, and an always-visible Today permission entry with a settings fallback. It is not merged or released.
