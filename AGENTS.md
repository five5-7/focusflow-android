...
- The current development candidate is `8.2.1-rc.2` / versionCode 527. It extends the optional appearance system with distinct acrylic and frosted-glass profiles; rich appearance remains disabled by default.
- The current official release is `8.2.0` / versionCode 525 (the fourth formal release). It adds the coordinate-aligned acrylic material experiment as a retained optional appearance.
