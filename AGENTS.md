...
- The current development candidate is `8.0.0-rc.2` / versionCode 509. The current official release remains `7.1.3`; earlier 7.4–7.12 candidates are historical inputs to this integration candidate.
