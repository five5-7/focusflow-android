...
- The current development candidate is `8.3.0-rc.5` / versionCode 539: centralized permission/reminder guidance, a unified course-import result boundary, and startup work moved away from the first composition. By maintainer instruction its RC number continues after rc.4 instead of resetting to rc.1. School timetable web data and target-device performance verification remain incomplete. It is not merged or released.
