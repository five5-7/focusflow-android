...
- The current release-preparation candidate is `7.4.0` / versionCode 488. The current official release remains `7.1.3`; `7.2.0` and `7.3.0-rc.4` remain unmerged predecessor candidates.
