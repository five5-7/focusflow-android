...
- The current development candidate is `7.7.0-rc.2` / versionCode 495. The current official release remains `7.1.3`; `7.4.0` is the verified but not yet published predecessor candidate.
