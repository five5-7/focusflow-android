...
- The current development candidate is `7.3.0-rc.3` / versionCode 485. The current official release remains `7.1.3`; `7.2.0` / versionCode 482 remains an unmerged release-build candidate.
