...
- FocusFlow uses 0.1 product-version increments, with patch versions for release fixes. The current release candidate is `7.1.2` / versionCode 477. Device acceptance is required before labeling it stable.
