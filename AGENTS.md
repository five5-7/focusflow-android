...
- The current development candidate is `7.5.0-rc.2` / versionCode 490. The current official release remains `7.1.3`; `7.4.0` is the verified but not yet published predecessor candidate.
