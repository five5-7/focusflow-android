...
class UserGuideContentTest {
    ...
    @Test fun `update highlights never fall back for known versions`() {
        ...
        for (version in listOf("8.3.0-rc.21", "8.3.0-rc.20", "8.3.0-rc.19", "8.3.0-rc.18", "8.3.0-rc.17", "8.3.0-rc.16", "8.3.0-rc.15", "8.3.0-rc.14", "8.3.0-rc.13", "8.2.2", "8.2.1", "8.2.0", "8.1.1", "8.1.0", "7.12.0", "7.9.0-rc.2", "7.9.0")) {
