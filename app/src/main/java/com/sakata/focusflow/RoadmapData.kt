...
object RoadmapData {
    ...
    val evolution: List<RoadmapVersion> = listOf(
        RoadmapVersion("8.2.1", listOf(
            RoadmapEntry("8.2.1-rc.2", "亚克力与毛玻璃扩展", "新增亚克力与毛玻璃：亚克力轻度模糊并带主题色，不加描边；毛玻璃模糊更强，并有完整的圆角亮边。悬浮底栏和页内弹窗会透出并模糊实际遮住的内容，文字和按钮保持清晰。丰富外观默认关闭，旧设置继续兼容。", RoadmapStatus.CANDIDATE)
        )),
