...
当前开发候选：**7.7.0-rc.2**（versionCode 495），在 rc.1 的默认设置说明、零经验快速入门与版本更新提示基础上，新增只在用户主动打开时展示的“使用说明书”：保留完整功能、默认设置和常见问题，并与快速入门互相链接。7.4.0 已通过自动门禁但尚未建立 GitHub Release；当前正式版仍为 [7.1.3](https://github.com/five5-7/focusflow-android/releases/tag/v7.1.3)。版本规则见 [VERSIONING.md](VERSIONING.md)，更新记录见 [CHANGELOG.md](CHANGELOG.md)。
