...
当前开发候选：**7.5.0-rc.1**（versionCode 489），聚焦“从想法到下一步”：收集箱可整理为逐步推进或参考，父想法与原说明保留，下一步作为关联任务单独进入收集箱。7.4.0 已通过自动门禁但尚未建立 GitHub Release；当前正式版仍为 [7.1.3](https://github.com/five5-7/focusflow-android/releases/tag/v7.1.3)。版本规则见 [VERSIONING.md](VERSIONING.md)，更新记录见 [CHANGELOG.md](CHANGELOG.md)。
