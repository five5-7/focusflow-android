...
当前开发候选：**7.6.0-rc.1**（versionCode 491），聚焦课程手动新增、地点与出行参数易懂化：支持周一至周日，使用“第几节开始＋连续几节”，并明确新安装的地点与通勤默认值。7.4.0 已通过自动门禁但尚未建立 GitHub Release；当前正式版仍为 [7.1.3](https://github.com/five5-7/focusflow-android/releases/tag/v7.1.3)。版本规则见 [VERSIONING.md](VERSIONING.md)，更新记录见 [CHANGELOG.md](CHANGELOG.md)。
