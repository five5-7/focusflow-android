...
当前开发候选：**7.11.0-rc.1**（versionCode 504），课程可设置启用状态与可选生效日期，并支持单门或批量删除；空挡按建议、课间、自由时段和课表切换；通勤增加可调距离档位及未知路线默认兜底。既有课程与通勤设置按兼容默认值读取。7.4.0 已通过自动门禁但尚未建立 GitHub Release；当前正式版仍为 [7.1.3](https://github.com/five5-7/focusflow-android/releases/tag/v7.1.3)。版本规则见 [VERSIONING.md](VERSIONING.md)，更新记录见 [CHANGELOG.md](CHANGELOG.md)。
