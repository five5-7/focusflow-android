...
当前开发候选：**7.3.0-rc.1**（versionCode 483），聚焦 Health Connect 睡眠背景与分时段个人精力模型；`7.2.0` / versionCode 482 仍是未合并的发布构建候选。当前正式版仍为 [7.1.3](https://github.com/five5-7/focusflow-android/releases/tag/v7.1.3)。版本规则见 [VERSIONING.md](VERSIONING.md)，更新记录见 [CHANGELOG.md](CHANGELOG.md)，7.3 验收见 [检查表](docs/7.3-checklist.md)。
