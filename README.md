...
当前待发布版本：**7.4.0**（versionCode 488），聚焦低成本精力基线采样：轮换时段、样本完成后降频及维护期抽查。`7.3.0-rc.4` 保留为上一候选；在 GitHub Release 创建前，正式版仍为 [7.1.3](https://github.com/five5-7/focusflow-android/releases/tag/v7.1.3)。版本规则见 [VERSIONING.md](VERSIONING.md)，更新记录见 [CHANGELOG.md](CHANGELOG.md)，7.4 验收见 [检查表](docs/7.4-checklist.md)。
